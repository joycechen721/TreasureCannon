...
export default class Person extends Object {
    constructor() {
        ...
        this.materials = {
            ...
            rightarm: new Material(new defs.Phong_Shader(),
                {ambient: .4, diffusivity: .6, color: hex_color("#FFFFFF")}),
            leftarm: new Material(new defs.Phong_Shader(),
                {ambient: .4, diffusivity: .6, color: hex_color("#FFFFFF")}),
            rightleg: new Material(new defs.Phong_Shader(),
                {ambient: .4, diffusivity: .6, color: hex_color("#68BEF4")}),
            leftleg: new Material(new defs.Phong_Shader(),
                {ambient: .4, diffusivity: .6, color: hex_color("#68BEF4")}),
        }
    }
    ...
    render(context, program_state, model_transform=Mat4.identity(), move_amt=0) {
        ...
        this.shapes.leg.draw(context, program_state, rightarm_transform, this.materials.rightarm);
        this.shapes.leg.draw(context, program_state, leftarm_transform, this.materials.leftarm);
        this.shapes.leg.draw(context, program_state, rightleg_transform, this.materials.rightleg);
        this.shapes.leg.draw(context, program_state, leftleg_transform, this.materials.leftleg);
    }
}
